...
gui.add(material.uniforms.uFraquency.value, 'x').min(0).max(20).step(0.01).name('frequencyX');
gui.add(material.uniforms.uFraquency.value, 'y').min(0).max(20).step(0.01).name('frequencyY');
